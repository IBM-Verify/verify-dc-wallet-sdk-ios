...
**Xcode project:** File → Add Package Dependencies → enter the URL below and set the version rule to `Up to Next Major Version` from `1.0.0`.

```
https://github.com/ibm-verify/verify-dc-wallet-sdk-ios.git
```
...
8. Update the consuming app to the new version
